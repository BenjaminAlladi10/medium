...
export const Appbar = () => {
    return (
        <div className="border-b flex flex-col md:flex-row justify-between px-10 py-4">
            <Link to={"/blogs"}>
            ...
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="flex justify-center flex-col pt-2 md:mr-1">
                    <Link to={"/publish"}>
                        <button
                            type="button"
                ...
                <div className="flex flex-col items-center pt-2 md:pr-3">
                    <Link to={"/signin"}>
                        <button
                            type="button"
                            className="font-serif text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center mb-2">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
                                height="20"
